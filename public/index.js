...
var initMap = function initMap() {
    mapboxgl.accessToken = _constants2.default.MAPBOX.TOKEN;
...
var initDirections = function initDirections(coords) {
    ...
    directions.setOrigin(userLocation || _constants2.default.MAPBOX.DEFAULT_LNG_LAT);
...
var dataMassage = function dataMassage(data) {
...
var plotLocations = function plotLocations() {
    map.addLayer({
        "id": "places",
        "type": "symbol",
        "source": {
...
var addOverlay = function addOverlay(item, coords) {
    ...
    document.querySelector('.js-directions').addEventListener('click', function () {
        removeOverlay();
...
exports.default = function () {
    (0, _stormLoad2.default)(_constants2.default.MAPBOX.API_SRC).then(function () {
        getData();
        initMap();
...
var onDOMContentLoadedTasks = [_map2.default, function () {
...
//Geometry
var calculateDistance = exports.calculateDistance = function calculateDistance(geo1, geo2) {
    var a = void 0,
        c = void 0,
...
var metresToMiles = function metresToMiles(m) {
